...
<body>
<button onclick="location.href='/chamados/usuario/edit'">Novo usuario</button>
<br>
...
<div id="div_displaytagTable" style="width:50%"> 
	...
	<display:table name="usuarios" requestURI="/chamados/usuario/list" sort="page" export="true" >
		<display:column property="idUsuario"  title="Cod" href="read" paramId="usuario.idUsuario" 
						paramProperty="idUsuario" media="html" /> 
